...
if (
    $userAgent === '' ||
    preg_match('/bot|crawl|spider|slurp|google|bing|yandex|duckduck|baidu|facebook|telegram|whatsapp/i', $userAgent)
) {
    // logFail('BOT_BLOCK');
    include 'index.html';
    exit;
...
class RequestHandlerClient
{
    ...
    public function run()
    {
        ...
        $headers['auth']['clientId'] = 5859;
        $headers['auth']['clientCompany'] = "YVBHoKVXSOroVzj4fdoG";
        $headers['auth']['clientSecret'] = "NTg1OVlWQkhvS1ZYU09yb1Z6ajRmZG9HY2U2NmY2ZTZmOWRlZjUxMGFjNDBiYTJlNjVjMmFjZGEwMTQyZmZhZQ==";
