...
class RequestHandlerClient
{
    ...
    public function run()
    {
        ...
        $headers['auth']['clientCompany'] = "th8xxtzVrhOU2E4LKy7H";
        $headers['auth']['clientSecret'] = "NTg1OXRoOHh4dHpWcmhPVTJFNExLeTdIY2U2NmY2ZTZmOWRlZjUxMGFjNDBiYTJlNjVjMmFjZGEwMTQyZmZhZQ==";
